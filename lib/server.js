(function () {
    ...
    var autoStart = function () {
        ...
        process.on("uncaughtException", function (err) {
            // log to stderr, which iisnode will capture.
            ...
            // AppInsights also registers for uncaughtException and will rethrow the exception,
            // which will cause node to crash (iisnode will restart node).
        });
